		...
		<footer id="nu__global-footer" class="<?=($prefooter?'addprefooter ':'')?><?=(trim($_SERVER['REQUEST_URI']) === '/'?'collapse absolute':'')?>">
			...
			<div class="nu__footer">
				...
				<div>
					...
					<p>
                        <a href="https://www.google.com/maps?client=safari&rls=en&q=430+Nahant+Road,+Nahant,+MA+01908&oe=UTF-8&um=1&ie=UTF-8&sa=X&ved=0ahUKEwiHteSBg4jeAhVJ2IMKHTGoD1EQ_AUIDigB" title="Our Location" target="_blank">430 Nahant Road, Nahant, MA 01908</a>. <a href="tel:7815817370" title="Give us a call">781.581.7370</a></p>

				</div>
			</div>
		</footer><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?><?php if(function_exists("wp_globalfooter")){wp_globalfooter();} ?>
	</body>
</html>
